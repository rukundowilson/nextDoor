      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8">
            ...
            <p className="text-blue-100 text-center mt-2">Manage your store</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="px-6 py-8 space-y-6">
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="w-full text-blue-600 font-semibold py-2.5 rounded-lg hover:bg-blue-50 transition"
            >
              ← Back to Store
            </button>
          </form>
